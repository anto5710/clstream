...
public:
    ...
    /**
     * @brief Begin applying given ANSISequence to all that follows
     * and retunrs this instance in chain
     ...
     * by calling 'reset-all' sequence and re-enacting all previous sequences.
     *
     * @return ColorStream& this stream instance
     */
    ColorStream &undo()
